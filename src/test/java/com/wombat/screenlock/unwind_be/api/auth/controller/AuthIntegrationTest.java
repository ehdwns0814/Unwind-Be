 ...
 * 
 * <p>
 * MockMvc를 사용하여 AuthController의 엔드포인트를 통합 테스트합니다.
 * </p>
 * 
 * <h3>테스트 범위</h3>
 * <ul>
...
class AuthIntegrationTest {
    ...
    @Nested
    @DisplayName("[REQ-FUNC-024] POST /api/auth/signup")
    class SignupApi {

        @Test
        @DisplayName("[TC-041] 유효한 요청으로 회원가입 성공")
        void should_ReturnToken_When_ValidRequest() throws Exception {
            // Given
            SignUpRequest request = new SignUpRequest("newuser@test.com", "password123");
        ...
        @Test
        @DisplayName("[TC-042] 이미 존재하는 이메일로 회원가입 시 409 반환")
    ...
    @Nested
    @DisplayName("[REQ-FUNC-025] POST /api/auth/login")
    class LoginApi {

        @Test
        @DisplayName("[TC-043] 유효한 인증 정보로 로그인 성공")
        ...
        @Test
        @DisplayName("[TC-044] 존재하지 않는 이메일로 로그인 시 401 반환")
        ...
        @Test
        @DisplayName("[TC-044] 잘못된 비밀번호로 로그인 시 401 반환")
        ...
        @Test
        @DisplayName("[TC-044] 이메일 형식이 잘못된 경우 400 반환")
    ...
    @Nested
    @DisplayName("[REQ-FUNC-031] POST /api/auth/refresh")
    class RefreshApi {

        @Test
        @DisplayName("[TC-045] 유효한 Refresh Token으로 토큰 갱신 성공")
        ...
        @Test
        @DisplayName("[TC-046] 유효하지 않은 Refresh Token으로 갱신 시 401 반환")
        ...
        @Test
        @DisplayName("[TC-046] Redis에 없는 토큰으로 갱신 시 401 반환")
        ...
        @Test
        @DisplayName("[TC-046] Refresh Token이 비어있는 경우 400 반환")
